...
4. 当你看见这个的时候，就说明稳了![控制台](../../图床/a980dbe5-a264-434c-a9c7-6a7ee6cfb272.png)
...
9. 然后你就会看到这个页面![控制台](../../图床/ee4a083c-0afd-4569-ba01-4802fd83dc73.png)如果没有，**耐心等待一小会**（五分钟)，再点刷新就能看见了，红圈圈中的，就是你的SpirngBoot项目名称
...
2. 配置好重启项目，然后**把类中的所有接口都进去一次**，然后回到控制台，这样就能指定接口去做控制![控制台](../../图床/820321b4-8919-4fe0-8150-f9ebf7a78273.png)这里的/error是因为类中的1接口需要post方式进入，因此这里显示的错误，但是不影响
...
1. 如图所示，选择你要限流的接口，然后单机阈值就是**单台服务器能接受最大值qps**![控制台](../../图床/d5f87c29-3e90-4c0e-99c0-bd163b3a5511.png)
2. 设置好后，就可以在**流控规则**看见你所设置的规则![8d7ed69d-38d9-4003-80e0-39333012b635](../../图床/8d7ed69d-38d9-4003-80e0-39333012b635.png)
...
- 这是Sentinel的熔断选项图![熔断](../../图床/0fea8b8b-e513-4628-b54a-b532af0e1129.png)
...
- Seata在业务中，充当事务协调者，如图所示![ppt](../../图床/1f9e14b3-b5f2-4413-b993-45b00cfa9507.png)
...
4. 图解![图](../../图床/f1359253-d303-46e7-ab26-9333f48f3d7e.png)
...
1. 去[官网](https://seata.apache.org/unversioned/download/seata-server/)下载Seata，一定要下载圈住的**超链接**![1fb8f922-cb9e-4162-95a0-599051e4617c](../../图床/1fb8f922-cb9e-4162-95a0-599051e4617c.png)
...
9. 接下来把txt文件改成bat，改一个能记住的名字，可以如图所示![目录](../../图床/3efe7ba3-bf40-4921-82eb-7cff51036283.png)

10. 然后**启动seata-server.bat程序**，如果闪退，就尝试启动你刚才写好的bat程序

11. 当启动好后，去Nacos服务查看![Nacos](../../图床/cab2dc80-13ec-4989-a539-ad9dcbfe5e89.png)
...
13. 然后点击这里切换中文![控制台](../../图床/2a0a2343-c04d-48e2-a5aa-b013aafdaf39.png)
...
- 具体原理如图![图](../../图床/39b930dc-c3c7-401f-8ecd-44c472f79a8b.png)
