...
本次环境安装基于**SpringBoot**实现

1. 首先在**idea**中，新建一个**springboot**项目，然后勾选图中的依赖![配置](../../图床/46d1f6d9-fac9-4090-9a2c-718e5b4060cd.png)
...
1. idea的数据库下（注意，**idea**端下**无法删除**这个数据）![idea](../../图床/6a1e5854-9d6f-41b5-b198-1b98ce7b896c.png)
2. RESP下![resp](../../图床/53c13e02-d351-4999-bf68-daf9793a2fff.png)
