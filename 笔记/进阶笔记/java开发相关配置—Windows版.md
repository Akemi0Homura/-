...
2. 要下载这个版本的![版本](E:\code\笔记\图床\e982a7b0-de4f-401a-aafa-b4a01d153167-1731764533568-1.png)
...
10. 首先下载的第一个插件就是ui插件，能让idea更漂亮美观(Material Theme UI Lite)![idea](E:\code\笔记\图床\0860ab61-9c95-4881-90bc-503c0873bf3b.png)
11. 然后就是这个插件，可以让括号变成彩色，在以后编程更加方便(Rainbow Brackets Lite)![idea](E:\code\笔记\图床\3a4d1d37-7f5c-40d1-9284-3a5cf333e798.png)
...
1. 前往[官网](https://maven.apache.org/download.cgi)下载圈住的版本![maven](E:\code\笔记\图床\12b90d2b-7493-4512-9190-ddd25d098e04.png)
...
8. 然后复制后去到**环境变量**设置中，在**系统变量中找到path**，点进去后**新建变量**，然后**输入你刚才复制的安装目录**中![maven](E:\code\笔记\图床\9f07b5ee-662e-4519-a02f-86f8e8b72f44.png)
...
10. 然后接下来就是打开idea，点击自定义，点击配置![idea](E:\code\笔记\图床\d49434fa-3551-4697-bf7d-f97f75022852.png)

11. 点击左边构建、执行、部署=>构建工具=>maven-->![idea](E:\code\笔记\图床\2eaecec7-df55-43bb-b96b-dcfd09c9507b.png)其中主路径就是maven目录，用户设置文件就是刚才修改了阿里云仓库的配置文件，本地仓库就是新建的文件夹，设置好保存

12. 设置好保存，然后建立一个maven项目-->![idea](E:\code\笔记\图床\7d970c29-4736-410a-8136-d4e0a2bf6de4.png)

13. 然后等待maven插件下载完成-->![maven](E:\code\笔记\图床\ab955572-56fb-45e0-a638-1b6f5e7a627d.png)
...
15. 然后在test/java下新建一个类-->![idea](E:\code\笔记\图床\9e63d4df-0499-4d93-92c0-bf179cf30ee5.png)

16. 然后在方法名上，**打@Test，只要有联想**，就说明已经成功![idea](E:\code\笔记\图床\QQ20241117-215239.png)

### 导入成功，但无效果

- 如果你导入成功jar包，如图-->![idea](E:\code\笔记\图床\93351dfe-d50e-44ce-b8cc-cb91bafdccf6.png)
...
1. 首先打开这个[网站](https://downloads.mysql.com/archives/community/)，选择好系统和下载文件-->![idea](E:\code\笔记\图床\bbe2058c-508c-4038-ab6d-56048831b2f1.png)

1. 运行后**一直下一步**，直到这个页面-->![mysql](E:\code\笔记\图床\c65a48ad-dacc-47f0-bab8-c18e8be29b37.png)

   这里选择中间，然后一直下一步

1. 到了这个页面，就开始配置mysql，这里**没有展示的页面，就是默认直接下一步**-->![mysql](E:\code\笔记\图床\c26ce979-4363-4c40-9003-e3ed180e21e3.png)

1. 这个页面设置一下数据库名字，建议是mysql+版本号，例如8.4，就叫mysql84-->![mysql](E:\code\笔记\图床\cadc1f88-f251-4496-822d-090f00dad3a0.png)

1. mysql内置一个root管理员账户，这里是设置其密码-->![mysql](E:\code\笔记\图床\8fadb23b-a7b5-42ee-8a7c-61c98e858181.png)

1. 这里点击下面的**Execute**下载配置-->![mysql](E:\code\笔记\图床\bd887317-a9bd-4a43-9784-fa4b2cfd86b8.png)

1. 到了这个页面后，**开始设置系统变量**，和maven方法相同-->![mysql](E:\code\笔记\图床\34e44232-d687-4be4-a268-0eee9b2d0853.png)

1. 复制mysql的安装目录下的bin目录，然后粘贴到path里-->![img](E:\code\笔记\图床\37a78d1a-0611-49b6-bab6-29c30bc899a3.png)
...
1. 结果如图-->![img](E:\code\笔记\图床\00158744-eabb-4385-8027-28df81f9287c.png)

1. 然后是连接数据库，这里**客户端使用idea**,随便进一个项目

1. 然后依次点击打开页面-->![idea](E:\code\笔记\图床\157d04a6-cd78-4c4a-9189-df2358fa99c3.png)

1. 点击+号找到mysql-->![idea](E:\code\笔记\图床\e61e4a9d-8903-4a9d-b85c-92ba3cd2dfed.png)

1. 然后点击这个下载驱动-->![idea](E:\code\笔记\图床\e85afaab-bc82-4775-903d-e34716deb2a2.png)

1. 下载完成后，输入账号和密码-->![idea](E:\code\笔记\图床\3308b849-04d2-4bfd-b4ec-184f96d8e869.png)

   其中账号为：root

   密码是你自己设置的

1. 然后点击**测试连接**，成功就代表idea已经连进数据库中-->![idea](E:\code\笔记\图床\b68c4f8b-b930-42c4-ac97-5a76b26a3097.png)

1. 点击这里的**架构**，下面的就是数据库-->![idea](E:\code\笔记\图床\d8acdda2-f501-4e0a-8c96-5ada5646f27e.png)
...
1. 然后就能查询出来-->![idea](E:\code\笔记\图床\02833b07-ef0f-485f-9ee7-e24de0443904.png)

### 配置失败

1. 如图，如果你的配置卡在这个地方-->![idea](E:\code\笔记\图床\fcda61fc-ed53-4b8b-bc56-890fa15269bc.png)

2. 那么可能是因为你的**电脑名为中文**导致的

3. 打开电脑设置，查看系统信息，看这台**电脑名为中文**-->![idea](E:\code\笔记\图床\4f7e5676-5e7b-494b-999e-87cbe4901b56.png)

4. 把名字改成英文，然后**重启电脑**

5. 重启好后，去设置=>应用中删除mysql-->![idea](E:\code\笔记\图床\11b09e27-67b9-49d7-b43f-785db97050eb.png)

6. 删好后去c盘目录删除mysql的数据，如果你**前面没有修改**的话，那么默认目录如图![idea](E:\code\笔记\图床\QQ20241118-125724.png)
...
1. 首先前往https://www.jetbrains.com/webstorm/download/other.html下载![web](E:\code\笔记\图床\7f760907-d07e-490a-8ce8-d09737074d1a.png)
2. 下载后解压，选择**非商业使用**-->![webstorm](E:\code\笔记\图床\086ad46a-23c1-49d6-b76e-2c76fbdf8887.png)
3. 进到这个页面，选择一个账号登录-->![web](E:\code\笔记\图床\a7918910-f1f0-44d7-a4d9-62d48ca000ce.png)
4. 登录后，就能获得**一年的免费使用**。然后在这里随便创建一个项目进去-->![webstorm](E:\code\笔记\图床\a441a744-320a-4ca8-ae55-2956bc30b2c5.png)
5. 进去后，点击右下角**切换语言**-->![webstorm](E:\code\笔记\图床\3373c7ac-eccc-49bc-830b-ba7178636ee9.png)
...
1. 创建一个vue项目，让webstorm下载node和npm-->![webstorm](E:\code\笔记\图床\a382d245-3d8c-4a9a-8513-154ee9432063.png)

2. 进入后进入终端，输入代码更换npm下载源（下载速度更快）-->![webstorm](E:\code\笔记\图床\f4dc3d60-f5b5-4ca7-9a05-05453bf3c2f1.png)
...
4. 打印这个信息时候，用方向键选择vue版本-->![webstorm](E:\code\笔记\图床\84227de3-5b01-4a5a-ae17-9111ec73c76f.png)

5. 选择好后,等待一段时间，直到上面出现npm-->![webstorm](E:\code\笔记\图床\1a915650-b807-4dc2-bcdc-1b0dbbac06e4.png)

6. 运行后，点击下面的网址，看到vue标志后，创建完成-->![webstorm](E:\code\笔记\图床\4a31aa79-bce3-4826-86d9-bfd11b710bbb.png)
...
1. 首先前往[redis客户端](https://github.com/lework/RedisDesktopManager-Windows/releases/tag/2022.5)下载-->![github](E:\code\笔记\图床\8357747e-62ef-4133-8126-1b4512dd3a4f.png)

2. 下载后，**无脑下一步**，记得调整安装目录

3. 这里填写url地址-->![resp](E:\code\笔记\图床\6d9a4434-ff39-4b43-a913-2935c77fa152.png)
...
5. 填写好,用端口号取名，redis图形客户端安装完成-->![resp](E:\code\笔记\图床\7cecc746-1b0e-434c-b36e-5ef3ccc83cfd.png)
...
1. 首先，在**redis目录下**，新建两个文件夹,建议**文件夹名为端口号**![文件夹](E:\code\笔记\图床\c7cbd03a-aa74-4406-b6bd-3dd03b1c92ac-1731987702064-1.png)
...
4. 这里截个图大概对照一下![文件夹](E:\code\笔记\图床\9ad05d76-59ae-465f-afaf-6e79f83f7395-1731987702064-2.png)
...
7. 然后观察如果运行后像图中这样![cmd界面](E:\code\笔记\图床\1207e3bd-ca5c-4ab9-935f-e20fdf600c90-1731987702064-3.png)这里的**127.0.0.1是你前面配置文件设置得来的**。
...
11. 运行后你将看见图中的效果![cmd界面](E:\code\笔记\图床\f460d917-f5a2-4001-b0bf-a0d87ebb5eb0-1731987702064-4.png)
...
6. 写好后我的目录大概就是这样![配置](E:\code\笔记\图床\5f4a0f22-4b90-4a37-a244-dacae16fb13c-1731999586156-10.png)带s的就是哨兵，不带s就是从库启动

7. 然后启动**刚才写好**的**cmd程序**（注意，**一定要先完成主从复制的架构搭建**）![启动程序](E:\code\笔记\图床\f6d1fd62-8e75-4feb-8729-19ecf8dde17e-1731999586155-9.png)
...
3. 找到后**打开Navicat数据库软件**（使用idea也行，但是你得在每个表名上加上一个数据库名称，不然无法执行代码），然后**新建一个库叫Nacos**，然后在库中新建一个查询，然后把刚才的**.sql文件打开**，把里面**所有东西复制粘贴到查询窗口上**，然后**运行代码**，运行结束后吗的库表应该和我一致![数据库](E:\code\笔记\图床\b486170d-74bb-41f7-8a94-ee54120f8cfd-1732065723265-1.png)
...
5. 添加后启动两个项目回到页面刷新，你就会发现列表已经出现**两个服务**，**说明服务注册成功![Nacos页面](E:\code\笔记\图床\80e5d89c-82b1-4321-bf72-80e9ee277a04-1732065723265-2.png)**

6. **还没完**，因为实际项目中，**一个模块服务会有多个实例**，因此我们也需要进行相对于的配置

7. 首先打开这个设置![idea](E:\code\笔记\图床\QQ20241030-215407-1732065723266-3.png)

8. 然后框选要复制的项目，然后点击一下![idea](E:\code\笔记\图床\QQ20241030-215526-1732065723266-7.png)

9. 然后**修改**一下**名称**，然后再点击一下这个界面的**修改选项**（有高亮显示），点击添加**虚拟机选项**![idea](E:\code\笔记\图床\QQ20241030-215648-1732065723266-4.png)
...
11. 然后在外面启动这个项目![idea](E:\code\笔记\图床\QQ20241030-215926-1732065723266-6.png)

12. 然后去到**Nacos页面**，刷新一下，就会发现实例从1变成2![4f86e5ac-1f73-455c-8f4e-c9cd41695190](E:\code\笔记\图床\4f86e5ac-1f73-455c-8f4e-c9cd41695190-1732065723266-5.png)
...
3. 然后在配置nacos上发布配置文件-->![nacos](E:\code\笔记\图床\f1054698-7d60-4c83-b13f-47e2b2686e7b.png)

4. 第一个是配置id，第二个就是配置文件介绍，第三个就是文件格式，第四个就是配置信息![QQ20241122-085136](E:\code\笔记\图床\QQ20241122-085136.png)
...
8. 之后把需要进行测试代码完成，然后启动程序测试我们能看见一些信息-->![控制台](E:\code\笔记\图床\5a2e5300-e0c7-465e-a8e8-9c0a4b0a1263.png)
...
4. 当你看见这个的时候，就说明稳了![控制台](E:\code\笔记\图床\a980dbe5-a264-434c-a9c7-6a7ee6cfb272-1732079299063-1.png)
...
9. 然后你就会看到这个页面![控制台](E:\code\笔记\图床\ee4a083c-0afd-4569-ba01-4802fd83dc73-1732079299063-2.png)如果没有，**耐心等待一小会**（五分钟)，再点刷新就能看见了，红圈圈中的，就是你的SpirngBoot项目名称
...
1. 去[官网](https://seata.apache.org/unversioned/download/seata-server/)下载Seata，一定要下载圈住的**超链接**![1fb8f922-cb9e-4162-95a0-599051e4617c](E:\code\笔记\图床\1fb8f922-cb9e-4162-95a0-599051e4617c-1732085103854-3.png)
...
9. 接下来把txt文件改成bat，改一个能记住的名字，可以如图所示![目录](E:\code\笔记\图床\3efe7ba3-bf40-4921-82eb-7cff51036283-1732085103854-2.png)

10. 然后**启动seata-server.bat程序**，如果闪退，就尝试启动你刚才写好的bat程序

11. 当启动好后，去Nacos服务查看![Nacos](E:\code\笔记\图床\cab2dc80-13ec-4989-a539-ad9dcbfe5e89-1732085103854-1.png)
...
13. 然后点击这里切换中文![控制台](E:\code\笔记\图床\2a0a2343-c04d-48e2-a5aa-b013aafdaf39-1732085103854-4.png)
...
5. 下载注意要下载**64位的安装程序**![官网](E:\code\笔记\图床\QQ20241109-110846-1732263536964-3.png)

6. 下载好运行，无脑下一步安装完成即可

7. 然后打开系统环境变量，**新建一个变量**![环境变量](E:\code\笔记\图床\503b1371-0303-4309-ae7b-53e0348bd693-1732263536965-4.png)
...
9. 安装好环境变量后，去cmd输入erl，如果看见版本号，说明**安装成功**![环境](E:\code\笔记\图床\a826f3a1-31f5-4039-8da2-f38ad01bfe05-1732263536964-2.png)

10. 安装好环境后，就开始安装RabbitMQ

11. 从[官网](https://www.rabbitmq.com/docs/download)在这个位置下载**windows版本程序**![环境](E:\code\笔记\图床\305dcf87-0454-497d-b326-05c7176eeac7-1732263536964-1.png)
...
18. 然后打开服务，找到RabbitMQ将其**停止运行**![服务](E:\code\笔记\图床\3489843d-9510-4722-9df9-c5612f32e9a8-1732263536965-7.png)
...
22. 当你看见这个页面的时候，恭喜，你RabbitMQ**已经成功部署**![控制台](E:\code\笔记\图床\1ccf64e6-c0d2-4c4d-a8b4-c92f1d43d5f7-1732263536965-6.png)
...
24. 当登录将会看见这个页面![控制台](E:\code\笔记\图床\c1576f9c-7013-4a6c-91f5-d4e82e800d8f-1732263536965-5.png)
